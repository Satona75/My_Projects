...
module EndpointDnsRecords_privateEndpointDnsRecordUniqueId '?' /*TODO: replace with correct path to [parameters('privateDnsForPrivateEndpointTemplateLink')]*/ = {
  ...
  params: {
    ...
    privateEndpointNicResourceId: (enablePrivateEndpoint
      ? reference_concat_Microsoft_Resources_deployments_variables_privateEndpointTemplateName_outputs_networkInterfaceId_value.outputs.networkInterfaceId.value
      : '')
